...
@Component({
  selector: 'app-honorario-anual',
  templateUrl: './honorario-anual.component.html',
  styleUrls: ['./honorario-anual.component.scss']
})
export class HonorarioAnualComponent implements OnInit {
      ...
      if(this.revisarCuentas()===true){
        ...
        for(let i = 3; i<this.excelData.length-1; i++){
          ...
          let obj = Object.assign({
            ...
            "periodo":this.excelData[i][0],
            "emisionesVigentes":this.excelData[i][1],
            "emisionesAnuladas":this.excelData[i][2],
            "honorarioBruto":this.excelData[i][3],
            "retencionTerceros":this.excelData[i][4],
            "retencionContribuyentes":this.excelData[i][5],
            "totalLiquido":this.excelData[i][6]
            })
