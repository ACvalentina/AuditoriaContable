...
@Component({
  selector: 'app-honorario-diario',
  templateUrl: './honorario-diario.component.html',
  styleUrls: ['./honorario-diario.component.scss']
})
export class HonorarioDiarioComponent implements OnInit {
      ...
      if(this.revisarCuentas()===true){
        ...
        for(let i = 3; i<this.excelData.length-1; i++){
          ...
          let obj = Object.assign({
            ...
            "usuarioEmisor":this.excelData[i][4],
            "fechaEmisor":this.excelData[i][5],
            "socProfEmisor":this.excelData[i][6],
            "brutosHonorarios":this.excelData[i][7],
            "retencionEmisorHonorarios":this.excelData[i][8],
            "retencionReceptorHonorarios":this.excelData[i][9],
            "liquidosHonorarios":this.excelData[i][10],
            })
  ...
  saveDetails(){
    ...
    const ref = collection(this.firestore,'Honorarios-Diario');
